			...
			{rooms.map((room) => {
				...
				return (
					<button
						...
						className={`flex items-center gap-3 px-4 py-3 text-left transition-colors border-b border-slate-100 dark:border-slate-800 hover:bg-sky-50 dark:hover:bg-slate-800 ${isActive ? 'bg-sky-50 dark:bg-slate-800 border-l-4 border-l-primary-500' : ''
							}`}
					>
						{/* Avatar */}
